...
const Wrapper = tw.div`p-4 flex max-[400px]:flex-col min-[400px]:flex-row justify-between gap-4 flex-wrap text-primary`;
    ...
    <footer>
      <Wrapper>
        ...
        <div className="flex-1  max-[400px]:max-w-xl min-[400px]:min-w-[300px]  grid grid-cols-2">
          <FooterLinks
            header={generalLinks.header}
            links={generalLinks.links}
          />
          <FooterLinks header={socialLinks.header} links={socialLinks.links} />
          <FooterLinks
            header={companyLinks.header}
